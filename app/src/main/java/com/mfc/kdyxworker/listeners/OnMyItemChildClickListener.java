...
public abstract class OnMyItemChildClickListener implements BaseQuickAdapter.OnItemChildClickListener {
    @Override
    ...
    public abstract void onMyItemChildClick(BaseQuickAdapter adapter, View view, int position);
    /**
     * 是否为连续点击，用于过滤连续多次点击.
     */
