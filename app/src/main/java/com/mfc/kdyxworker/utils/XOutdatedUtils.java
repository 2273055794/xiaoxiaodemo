package com.mfc.kdyxworker.utils;
...
public class XOutdatedUtils {
    ...
    public static Drawable getDrawable(@DrawableRes int id,
        ...
        return ResourcesCompat.getDrawable(App.getContext().getResources(), id, theme);
    }
    ...
    public static int getColor(@ColorRes int id, @Nullable Resources.Theme theme) {
        return ResourcesCompat.getColor(App.getContext().getResources(), id, theme);
    }
    ...
    public static ColorStateList getColorStateList(@ColorRes int id, @Nullable Resources.Theme theme) {
        return ResourcesCompat.getColorStateList(App.getContext().getResources(), id, theme);
    }
}
