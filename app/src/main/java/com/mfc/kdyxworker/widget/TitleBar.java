...
public class TitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private CommonTitleBar.OnTitleBarListener listener;
    private CommonTitleBar.OnTitleBarDoubleClickListener doubleClickListener;
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar);

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            // notice 未引入沉浸式标题栏之前,隐藏标题栏撑起布局
            fillStatusBar = array.getBoolean(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_fillStatusBar, true);
        }
        titleBarColor = array.getColor(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_titleBarColor, Color.parseColor("#1CBA53"));
        titleBarHeight = (int) array.getDimension(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_titleBarHeight, ScreenUtils.dp2PxInt(context, 44));
        statusBarColor = array.getColor(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_statusBarColor, Color.parseColor("#1CBA53"));
        statusBarMode = array.getInt(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_statusBarMode, 1);//0:hei, 1:bai

        showBottomLine = array.getBoolean(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_showBottomLine, true);
        bottomLineColor = array.getColor(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_bottomLineColor, Color.parseColor("#dddddd"));
        bottomShadowHeight = array.getDimension(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_bottomShadowHeight, ScreenUtils.dp2PxInt(context, 0));

        leftType = array.getInt(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_leftType, TYPE_LEFT_NONE);
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            leftText = array.getString(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_leftText);
            leftTextColor = array.getColor(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_leftTextColor, Color.parseColor("#FFFFFF"));
            leftTextSize = array.getDimension(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_leftTextSize, ScreenUtils.dp2PxInt(context, 16));
            leftDrawable = array.getResourceId(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_leftDrawable, 0);
            leftDrawablePadding = array.getDimension(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_leftDrawablePadding, 5);
        } else if (leftType == TYPE_LEFT_IMAGEBUTTON) {
            leftImageResource = array.getResourceId(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_leftImageResource, com.wuhenzhizao.titlebar.R.drawable.comm_titlebar_reback_selector);
        } else if (leftType == TYPE_LEFT_CUSTOM_VIEW) {
            leftCustomViewRes = array.getResourceId(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_leftCustomView, 0);
        }

        rightType = array.getInt(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_rightType, TYPE_RIGHT_NONE);
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            rightText = array.getString(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_rightText);
            rightTextColor = array.getColor(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_rightTextColor, Color.parseColor("#FFFFFF"));
            rightTextSize = array.getDimension(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_rightTextSize, ScreenUtils.dp2PxInt(context, 16));
        } else if (rightType == TYPE_RIGHT_IMAGEBUTTON) {
            rightImageResource = array.getResourceId(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_rightImageResource, 0);
        } else if (rightType == TYPE_RIGHT_CUSTOM_VIEW) {
            rightCustomViewRes = array.getResourceId(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_rightCustomView, 0);
        }

        centerType = array.getInt(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_centerType, TYPE_CENTER_NONE);
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            centerText = array.getString(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_centerText);
            centerTextColor = array.getColor(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_centerTextColor, Color.parseColor("#FFFFFF"));
            centerTextSize = array.getDimension(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_centerTextSize, ScreenUtils.sp2px(context, 16));
            centerTextMarquee = array.getBoolean(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_centerTextMarquee, true);
            centerSubText = array.getString(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_centerSubText);
            centerSubTextColor = array.getColor(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_centerSubTextColor, Color.parseColor("#666666"));
            centerSubTextSize = array.getDimension(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_centerSubTextSize, ScreenUtils.dp2PxInt(context, 11));
        } else if (centerType == TYPE_CENTER_SEARCHVIEW) {
            centerSearchEditable = array.getBoolean(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_centerSearchEditable, true);
            centerSearchBgResource = array.getResourceId(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_centerSearchBg, com.wuhenzhizao.titlebar.R.drawable.comm_titlebar_search_gray_shape);
            centerSearchRightType = array.getInt(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_centerSearchRightType, TYPE_CENTER_SEARCH_RIGHT_VOICE);
        } else if (centerType == TYPE_CENTER_CUSTOM_VIEW) {
            centerCustomViewRes = array.getResourceId(com.wuhenzhizao.titlebar.R.styleable.CommonTitleBar_centerCustomView, 0);
        }
    ...
    private void initGlobalViews(Context context) {
        ...
        if (showBottomLine) {
            ...
            viewBottomShadow.setBackgroundResource(com.wuhenzhizao.titlebar.R.drawable.comm_titlebar_bottom_shadow);
    ...
    private void initMainCenterViews(Context context) {
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            progressCenter.setIndeterminateDrawable(getResources().getDrawable(com.wuhenzhizao.titlebar.R.drawable.comm_titlebar_progress_draw));
            ...
            ivSearch.setImageResource(com.wuhenzhizao.titlebar.R.drawable.comm_titlebar_search_normal);
            ...
            if (centerSearchRightType == TYPE_CENTER_SEARCH_RIGHT_VOICE) {
                ivVoice.setImageResource(com.wuhenzhizao.titlebar.R.drawable.comm_titlebar_voice);
            } else {
                ivVoice.setImageResource(com.wuhenzhizao.titlebar.R.drawable.comm_titlebar_delete_normal);
            ...
            etSearchHint.setHint(getResources().getString(com.wuhenzhizao.titlebar.R.string.titlebar_search_hint));
...
//            }
    ...
    public void setListener(CommonTitleBar.OnTitleBarListener listener) {
        this.listener = listener;
    }

    public void setDoubleClickListener(CommonTitleBar.OnTitleBarDoubleClickListener doubleClickListener) {
